...
def evaluate(model, dataloader, o_sub_list, m_sub_list):
    ...
    for g1, g2, g3, labels1, labels2, labels3, num in dataloader:
        ...
        attention_DG = torch.cat((attention_DG, attention), dim=0) 
        attention_r_all = torch.cat((attention_r_all, attention_r), dim=0)
        num_list.append(num)
    ...
    return accuracy_task3, predicted, labels3, num_list, MAE1, MAE2,r2_1, r2_2, attention_DG, attention_r_all, weight, h3, label_task1, pred_task1, label_task2, pred_task2
